...
letter1 = (str(collections.Counter(letter1)))[-8]
letter2 = (str(collections.Counter(letter2)))[-8]
letter3 = (str(collections.Counter(letter3)))[-8]
letter4 = (str(collections.Counter(letter4)))[-8]
letter5 = (str(collections.Counter(letter5)))[-8]
letter6 = (str(collections.Counter(letter6)))[-8]
letter7 = (str(collections.Counter(letter7)))[-8]
letter8 = (str(collections.Counter(letter8)))[-8]
